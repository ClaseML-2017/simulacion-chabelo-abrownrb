...
# Formato a datos
csvformat -e iso-8859-1 -D "|" $DATA_DIR/prog_valoracion_del_desempeno.csv > $DATA_DIR/msd_data.csv
rm $DATA_DIR/prog_valoracion_del_desempeno.csv
